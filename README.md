...
![Security](https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExNnIybjFzM2x3Z3g4eWJmOHR6dTl5b2RnN3k3bTJrNnR6M3RpcSZlcD12MV9naWZzX3NlYXJjaCZjdD1n/3o6Zt481isNVuQI1l6/giphy.gif)

- 🔐 Аудит защищённости веб-приложений
- 🧩 Разработка инструментов пентеста
- 📡 Поиск уязвимостей и их документирование

---

## 🌐 Веб-разработка

![Web](https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExeTN3eGJ6b3R6dGZ4eWZjbHk3bTl0eW5yM3NxbjR3bGZsYiZlcD12MV9naWZzX3NlYXJjaCZjdD1n/2ikwIgNrmPZquNf8sq/giphy.gif)

- ⚛️ Фронтенд (React, TypeScript)
- 🖥️ Бэкенд (Node.js, Express, Telegram Bot API)
- 🗄️ Работа с базами данных (MongoDB, PostgreSQL)

---

## 🧩 Парсинг и автоматизация

![Automation](https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExeTN3eGJ6b3R6dGZ4eWZjbHk3bTl0eW5yM3NxbjR3bGZsYiZlcD12MV9naWZzX3NlYXJjaCZjdD1n/xT9DPhONuz1SpDJzHi/giphy.gif)
